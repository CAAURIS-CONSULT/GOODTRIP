...
from location.views import accueil, ajaxForMarques, rechercheVoiture, detailsVehicule, commander, history, passwordAndSettings
urlpatterns = [
    ...
    path('parametres',passwordAndSettings, name = 'settings_passw'),
]